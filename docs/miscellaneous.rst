...
.. warning::
 ...
 .. note::
     The layout of state variables in storage is considered to be part of the binary API
     due to the fact that storage pointers can be passed to libraries. This means that
